...
Reads the sprite kit (`frontend/gem/gem-sprites.json`, kit **v3**: palette-indexed 26×26
...
only the BODY and EYE are overridden — the kit's near-white body is a shade off the app's ink.
    ...
    python -m frontend.gem            # offline selfcheck (renders on Qt's offscreen platform)
"""
