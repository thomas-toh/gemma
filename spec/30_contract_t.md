...
| 2 | Reversible action | earcon announce (`ok`/`fail`) | audit |
| 3 | Destructive / consequential | **spoken confirmation** — orchestrator plays `confirm?`, requires the user to say "confirm" within 8 s, else cancels | audit |
