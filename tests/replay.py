...
simulation), brain (scripted Contract-B events) and TTS (silence of realistic length).
...
def main() -> None:
    ...
    setup_logging()
    ap = argparse.ArgumentParser(description="Gemma replay harness (Track G step 7)")
