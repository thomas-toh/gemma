...
# The routing prompt under test. The assistant persona asks a model to BE Gemma holding tools, and
...
def _ollama(endpoint: str, path: str, body: dict | None = None, timeout: int = 60):
    ...
    eviction cannot be asked for on the wire Gemma normally uses (tested 2026-08-02)."""
